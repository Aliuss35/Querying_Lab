...
def problem_four(request):
    ...
    print(f"Students count: {count_students}")
    count_instructors=Instructor.objects.count()
    print(f"Instructors count: {count_instructors}")
    count_courses=Course.objects.count()
    print(f"Courses count: {count_courses}")
...
def problem_five(request):
    new_student = Student.objects.create(first_name = 'Ali', last_name = 'Yildirim', gpa='3.3', year ='11')
...
def problem_six(request):
    ...
    updated_student = Student.objects.get(pk = student_id)
    print(f'ID: {updated_student.pk}\nFull name: {updated_student.first_name} {updated_student.last_name}\nGPA: {updated_student.gpa} ')
